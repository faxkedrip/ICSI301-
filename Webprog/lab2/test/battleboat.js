(function() {
    console.log("setDebug(true); use this command");

    // Global Constants
    var CONST = {};
    //CONST.AVAILABLE_SHIPS = ['carrier', 'battleship', 'destroyer', 'submarine', 'patrolboat'];
    CONST.AVAILABLE_SHIPS = ['ongots1','ongots2','ongots3'];
    ...
    Stats.prototype.updateStatsSidebar = function() {
        ...
        elWinPercent.innerHTML = this.gamesPlayed + " -c " + this.gamesWon;
    ...
    Game.prototype.checkIfWon = function() {
        if (this.computerFleet.allShipsSunk()) {
            ...
            alert('Харамсалтай байна! Компьютер хожлоо.');
            Game.gameOver = true;
            Game.stats.lostGame();
            Game.stats.syncStats();
            Game.stats.updateStatsSidebar();
